...
See real examples generated by the API:

- **Branded QR with Logo:** https://proof.digital/qr-logos/demos/branded-coral.png
- **WiFi QR Code:** https://proof.digital/qr-logos/demos/demo-wifi.png
- **vCard QR Code:** https://proof.digital/qr-logos/demos/test-vcard.png
- **Basic QR Code:** https://proof.digital/qr-logos/demos/test-gen.png
